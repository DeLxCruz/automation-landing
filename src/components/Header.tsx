  ...
  return (
    <header className="py-16 px-10">
      <section className="flex w-full items-center justify-between">
        ...
        <img
          className="md:h-full md:w-[700px] rounded-2xl"
          src="../../public/img/mujer-joven-tecnologia-casera.jpg"
          alt=""
        />
      </section>
        ...
        <ul className="flex items-center justify-center md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scroll">
          <li>
            <img
              width={130}
              height={40}
              src="../../public/img/google-2015-logo-svgrepo-com.svg"
              alt=""
            />
          </li>
          <li>
            <img
              width={130}
              height={40}
              src="../../public/img/amazon-echo-logo-svgrepo-com.svg"
              alt=""
            />
          </li>
          <li>
            <img
              width={130}
              height={40}
              src="../../public/img/samsung-1-logo-svgrepo-com.svg"
              alt=""
            />
          </li>
          <li>
            <img
              width={130}
              height={40}
              src="../../public/img/lg-electronics-logo-svgrepo-com.svg"
              alt=""
            />
          </li>
          <li>
            <img
              width={130}
              height={40}
              src="../../public/img/xiaomi-logo-svgrepo-com.svg"
              alt=""
            />
          </li>
        </ul>
